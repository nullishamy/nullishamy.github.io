...
#link("https://www.openssh.com/legacy.html")[From the legacy changelogs]
#quote[OpenSSH 7.0 and greater similarly disable the ssh-dss (DSA) public key algorithm. It too is weak and we recommend against its use.]
