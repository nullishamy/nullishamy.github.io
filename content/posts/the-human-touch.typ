...
This hurt. It was in this moment that I really had a reality check on the applicability of these technologies, the insincerity to not even write the summary yourself. It highlighted to me the importance of _the human touch_, the value of writing something yourself, and giving it your own little style.

Whilst the generated summary was _fine_, it wasn't anything special, it was cookie cutter bullet points with drawn out explanations, with little to no practical examples to really show off the skills I've worked hard on. Of course, I had to edit it in parts due to bad phrasing, grammar, etc, as the generator hadn't done any of that.

Something worth keeping in mind as we deal with this technology on a more regular basis. How would _you_ feel if you knew an important/sensitive message wasn't even human.
